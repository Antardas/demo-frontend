      ...
      <div className="about-content-container">
        <div className="content">
          ...
          <div className="about-content">
            ...
            <p>
              Chinmaya Mission® was established in India in 1953 by devotees of
              the world-renowned Vedanta teacher, His Holiness Swami
              Chinmayananda. Guided by his vision, devotees all around the world
              formed the nucleus of a spiritual renaissance movement that now
              encompasses a wide range of spiritual, educational, and charitable
              activities, ennobling the lives of thousands in India and across
              its borders. Presently, headed by His Holiness Swami
